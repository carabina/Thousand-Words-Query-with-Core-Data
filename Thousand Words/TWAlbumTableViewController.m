...
/* Each time the view appears on the screen do a query to core data for all Album objects we have saved */
...
/*  Notice that we are checking to see if your buttonIndex is 1, the location of our Add button.  We are then grabbing the text from the textfield, using a method textFieldAtIndex implemented by UIAlertView. */
...
/* Use the Album object to display information in our tableView cell */
